...
2- ssh -J {ssh-key} -p 2222 root@localhost -L 2053:localhost:2053

--- ساخت یک نمونه HTML ---
echo "<h1>Hello from my VM\!</h1>" > index.html
python3 -m http.server 8000 &

--- اتصال به پنل VPN ---
ssh -J {ssh-key} -p 2222 root@localhost -L 8000:localhost:8000
